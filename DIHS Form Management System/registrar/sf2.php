...
<html>
    ...
    <body>
        <?php include '../sidebar_component_registrar.php'; ?> 
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                ...
                                <input id="datepicker" class="form-control" placeholder="Select a date">
                                                        ...
                                                        <div class="col-md-4">
    <label for="classFilter" class="form-label">Select Class Section:</label>
    <select id="classFilter" class="form-control">
        <option value="">-- Select Class --</option>
        <?php
        include '../db_connect.php';
        $sectionQuery = "SELECT class_name FROM section ORDER BY class_name ASC";
                        ...
                        <div class="table-responsive">
                            <table id="attendanceTable" class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    include '../db_connect.php';
$sql = "SELECT sf1.LRN, sf1.Name, sf9.section 
        FROM sf1
        INNER JOIN sf9 ON sf1.LRN = sf9.LRN";
$result = mysqli_query($conn, $sql);
while ($student = mysqli_fetch_assoc($result)) {
    echo '<tr data-section="' . htmlspecialchars($student['section']) . '">';
...
$('#classFilter').on('change', function () {
    ...
    if (selectedClass) {
        // Show only rows with matching section
        $('#attendanceTable tbody tr').hide().filter(function () {
            return $(this).data('section') === selectedClass;
        }).show();
    } else {
    ...
    table.draw(false); // Redraw DataTable to reflect changes
});
...
$('#exportExcel').on('click', function() {
    ...
    window.location.href = 'export_sf2.php?month=' + encodeURIComponent(month) + '&class=' + encodeURIComponent(selectedClass);
});
