                                ...
                                if ($student_result === false) {
                                    ...
                                    while ($student = mysqli_fetch_assoc($student_result)) {
                                        echo "<tr>
                                            ...
                                            <td><button class='btn btn-sm btn-success attendanceBtn' data-lrn='{$student['LRN']}' data-name='" . htmlspecialchars($student['name']) . "'>Add</button></td>
...
<td><button class='btn btn-sm btn-success subjectBtn' data-lrn='{$student['LRN']}' data-name='" . htmlspecialchars($student['name']) . "' data-grade-level='" . htmlspecialchars($student['grade_level']) . "' title='Add'>Add</button></td>                                            <td class='text-center'>
                    ...
                    buttons: [
                        {
                            ...
                            title: 'Student_Data',
                            exportOptions: {
                                columns: [1,2,3,4,5] // Exclude checkbox and new columns
                            }
                        },
                        {
                            extend: 'pdfHtml5',
