...
<aside class="sidebar">
  ...
  <nav class="sidebar-nav">
    ...
    <ul class="nav-list primary-nav">
        ...
        <li class="nav-item">
          <a href="indexit.php" class="nav-link">
      ...
      <li class="nav-item">
        <a href="guidance_sf1.php" class="nav-link">
          <i class="nav-icon fas fa-users"></i>
          <span class="nav-label">SF1 - School Form</span>
        </a>
        <span class="nav-tooltip">SF1 - School Form</span>
      </li>
      <li class="nav-item">
